...
BQ_SERVICE_KEY = os.environ.get("GCS_CREDENTIALS", "")
...
def upload_to_gcs(local_path: str, drug_names: list) -> list:
    ...
    Uses the service-account JSON from GCS_CREDENTIALS env var.
    ...
    client   = storage.Client.from_service_account_json(BQ_SERVICE_KEY)
